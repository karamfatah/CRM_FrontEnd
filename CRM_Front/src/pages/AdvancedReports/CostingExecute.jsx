...
// // CostingExecute Component
// const CostingExecute = () => {
...
//     endDate: '',
//   });
//   const [selectedReportName] = useState('Execution report form || نموذج محضر إعدام');
//   const [reportNames] = useState(['Execution report form || نموذج محضر إعدام']);
...
//       const filteredReports = allReports.filter(report => report.name && report.name.trim() === 'Execution report form || نموذج محضر إعدام');
...
//               >
//                 <option value="Execution report form || نموذج محضر إعدام">
//                   Execution report form || نموذج محضر إعدام
//                 </option>
//               </select>
//             </div>
//             <div className="mb-6">
...
import { PrevArrow, NextArrow, ImageModal, ImageCarousel, ReportModal } from './CostingExecuteHelpers';
...
const CostingExecute = () => {
  ...
  useEffect(() => {
    ...
    if (hasPrivilegeCheck([5000, 1, 1010])) {
      console.log('User has privilege, fetching reports');
      setHasPrivilege(true);
      fetchReports();
    } else {
  ...
  if (!hasPrivilegeCheck([5000, 1, 1005])) {
    return (
      <div className="flex h-screen overflow-hidden">
        <Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} />
        <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
