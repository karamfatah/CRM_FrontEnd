...
// // import managementActionService from '../../lib/managementActionService';
...
// //             const url = await managementActionService.fetchImage(filename, accessToken);
...
// //   const [managementNotes, setManagementNotes] = useState(report.management_notes || '');
...
// //           const url = await managementActionService.fetchImage(filename, authData.access_token);
...
// //       try {
// //         const response = await managementActionService.getStatusHistory({
// //           id: reportId,
...
// //     setStatusError(null);
// //     try {
// //       const response = await managementActionService.updateReportStatus({
// //         id: reportId,
// //         orgId: authData.org_id,
// //         newStatus,
// //         accessToken: authData.access_token
...
// //         const historyResponse = await managementActionService.getStatusHistory({
// //           id: reportId,
// //           orgId: authData.org_id,
// //           accessToken: authData.access_token
// //         });
...
// //   const handleManagementNotesChange = async () => {
// //     const reportId = report.id || report._id?.$oid;
// //     console.log('Updating management notes:', { reportId, managementNotes });
// //     if (!reportId) {
// //       setManagementError(t('reports.invalid_report_id') || 'Invalid report ID');
// //       return;
// //     }
// //     setManagementLoading(true);
// //     setManagementError(null);
// //     try {
// //       const response = await managementActionService.updateManagementNotes({
// //         id: reportId,
// //         orgId: authData.org_id,
// //         managementNotes,
// //         accessToken: authData.access_token
// //       });
// //       console.log('Management notes update response:', response);
// //       onReportUpdate({ ...report, management_notes: response.report.management_notes });
// //       setManagementLoading(false);
// //     } catch (err) {
// //       console.error('Error updating management notes:', {
// //         message: err.message,
// //         response: err.response,
// //         reportId,
// //         orgId: authData.org_id
// //       });
// //       setManagementError(t('reports.management_error', { message: err.message }) || `Failed to update management notes: ${err.message}`);
// //       setManagementLoading(false);
// //     }
// //   };
...
// //   // Define current date for duration calculation
// //   const currentDate = new Date('2025-06-05T10:56:00.000Z');
...
// //             <button
// //               onClick={() => handleStatusUpdate('Under Management Action')}
// //               disabled={statusLoading || report.status !== 'Investigated'}
...
// //                 statusLoading || report.status !== 'Investigated'
...
// //               onBlur={handleManagementNotesChange}
...
// //               rows={4}
// //               aria-label={t('reports.management_notes') || 'Management Notes'}
// //             />
// //             {managementLoading && (
// //               <span className="text-gray-600 dark:text-gray-400 block mt-2">Updating...</span>
// //             )}
// //             {managementError && (
// //               <span className="text-red-600 dark:text-red-400 block mt-2">{managementError}</span>
// //             )}
// //           </div>
// //           <div className="mb-4">
// //             <h4 className="text-md font-medium text-gray-800 dark:text-gray-100 mb-2">
...
// //             </h4>
// //             <span className="text-sm text-gray-600 dark:text-gray-400">
// //               {report.investigation_details || t('reports.unknown') || 'N/A'}
// //             </span>
// //           </div>
// //           <div className="mb-4">
// //             <h4 className="text-md font-medium text-gray-800 dark:text-gray-100 mb-2">
...
// //     setLoading(true);
// //     try {
// //       const response = await managementActionService.getReports(authData.org_id, {
// //         page: currentPage,
// //         perPage,
...
// //                 {t('management_action.view_reports') || 'Management Action Reports'}
// //               </h1>
...
//     if (authData.privilege_ids?.includes(1004)) {
//       setHasPrivilege(true);
//       fetchReports();
//     } else {
//       setError(t('reports.no_permission') || 'No permission to view reports');
...
// Fix the view only fildes علشان ميلغبطش القانونيه 
...
import { useDebounce, ImageCarousel, ReportModal } from './ManagementActionHelpers';
...
const ManagementAction = () => {
  ...
  useEffect(() => {
    ...
    if (hasPrivilegeCheck([5000, 1, 1004])) {
      setHasPrivilege(true);
      fetchReports();
    } else {
      setError(t('reports.no_permission') || 'No permission to view reports');
