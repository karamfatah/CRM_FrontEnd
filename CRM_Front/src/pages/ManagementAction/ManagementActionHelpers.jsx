...
const ReportModal = ({ report, onClose, authData, t, onReportUpdate }) => {
  ...
  // Privilege check for updating status and management notes
  ...
  const handleManagementNotesChange = async () => {
    if (!hasPrivilege([5000, 1, 1004])) {
      setManagementError(t('reports.no_permission') || 'No permission to update management notes');
      return;
    }
